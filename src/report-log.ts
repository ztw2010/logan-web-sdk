...
import { LoganLogDayItem, FormattedLogReportName, LOG_DAY_TABLE_PRIMARY_KEY } from './lib/logan-db'
...
export default async function reportLog(reportConfig: ReportConfig): Promise<ReportResult> {
